...
int main()
{
    ...
    // glfwGetProcAddress gives the correct function based on which OS we're compiling for
    ...
    GLuint shaderProgram = loadShader("./shaders/triangle.vert", "./shaders/triangle.frag");
